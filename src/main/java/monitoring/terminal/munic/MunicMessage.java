...
public class MunicMessage implements Message {
	...
	/*
	 * Other fields:
	 * getIntegerField("ODO_FULL")
	 * getStringField("GPRMC_VALID")
	 * getBooleanField("DIO_ALARM")
	 * getStringField("DRIVER_ID")
	 * getIntegerField("DIO_IN_TOR")
	 * getIntegerField("BATT")
	 * getIntegerField("GPRS_HEADER")
	 * getIntegerField("RSSI")
	 * getIntegerField("BATT_VOLT")
	 * getBooleanField("MVT_STATE")
	 * 
	 * 
